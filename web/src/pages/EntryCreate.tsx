  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="space-y-5">
        ...
        <div>
          <label className="block text-sm text-text-muted mb-1.5 font-medium">Entry</label>
          <MarkdownEditor
            value={text}
            onChange={setText}
        ...
        <div>
          ...
          <TagInput id="entry-create-tags" tags={tags} onChange={setTags} />
        </div>
